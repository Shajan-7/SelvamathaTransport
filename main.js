...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const translations = {
    en: {
      ...
      hero_point_1: "Tamil Nadu ⇄ Kerala & Vice Versa: We pickup and deliver load anywhere in Tamil Nadu and Kerala (always exploring new locations).",
      hero_point_2: "Multiple pickup and multiple delivery available at nominal cost.",
      hero_point_3: "Send anything, anywhere, anytime, on correct time with 15+ heavy trucks and 25+ years experience.",
      ...
      caption_route: "Heavy Commercial Fleet • Regular Service",
      ...
      sec_fleet_title: "Heavy Commercial Lorries & Heritage",
    ...
    ta: {
      ...
      nav_about_fleet: "பற்றி & லாரிகள்",
      nav_quote: "முன்பதிவு",
      nav_contact: "தொடர்பு",
      hero_tag: "1998 முதல் தினசரி லாரி சேவை",
      hero_title_1: "பாதுகாப்பான & வேகமான லாரி போக்குவரத்து",
      hero_title_2: "தமிழ்நாடு ⇄ கேரளா",
      hero_point_1: "தமிழ்நாடு ⇄ கேரளா மற்றும் கேரளா ⇄ தமிழ்நாடு: எங்கும் சரக்குகளை ஏற்றி குறித்த நேரத்தில் இறக்குகிறோம் (புதிய இடங்களுக்கும் சேவை).",
      hero_point_2: "குறைந்த செலவில் பல இடங்களில் ஏற்றுதல் (Multiple Pickup) மற்றும் இறக்குதல் (Multiple Delivery) வசதி உண்டு.",
      hero_point_3: "எதையும், எங்கும், எப்போதும் சரியான நேரத்தில் கொண்டு சேர்க்க 15+ கனரக லாரிகள்.",
      ...
      caption_route: "செல்வமாதா லாரி • தினசரி சேவை",
      ...
      sec_fleet_title: "கனரக லாரிகள் & வரலாறு",
      sec_fleet_desc: "10 டன் முதல் 25 டன் வரை தாங்கும் வலிமைமிக்க கனரக வாகனங்கள்.",
    ...
    ml: {
      ...
      nav_about_fleet: "ഫ്ലീറ്റ് & ചരിത്രം",
      nav_quote: "ബുക്കിംഗ്",
      ...
      hero_point_1: "തമിഴ്‌നാട് ⇄ കേരളം സർവീസുകൾ: തമിഴ്‌നാട്ടിലും കേരളത്തിലും എവിടെനിന്നും ചരക്കുകൾ കയറ്റുകയും ഇറക്കുകയും ചെയ്യുന്നു.",
      hero_point_2: "കുറഞ്ഞ ചെലവിൽ മൾട്ടിപ്പിൾ പിക്കപ്പും മൾട്ടിപ്പിൾ ഡെലിവറിയും ലഭ്യമാണ്.",
      hero_point_3: "ഏതൊരു ചരക്കും കൃത്യസമയത്ത് എത്തിക്കാൻ 15+ ഹെവി കൊമേഴ്‌സ്യൽ ലോറികൾ.",
      ...
      caption_route: "സെൽവമാതാ ലോറി • പ്രതിദിന സർവീസ്",
      ...
      sec_fleet_title: "ഹെവി ലോറികൾ & ചരിത്രം",
      sec_fleet_desc: "10 മുതൽ 25 ടൺ വരെ ഭാരം വഹിക്കാൻ ശേഷിയുള്ള ഹെവി കൊമേഴ്‌സ്യൽ വാഹനങ്ങൾ.",
