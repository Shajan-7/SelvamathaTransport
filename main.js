...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const translations = {
    en: {
      ...
      hero_point_2: "Pickup and deliver load anywhere in Tamil Nadu and Kerala.",
    ...
    ta: {
      ...
      hero_point_2: "தமிழ்நாடு மற்றும் கேரளா முழுவதும் எங்கும் சரக்குகளை ஏற்றி குறித்த நேரத்தில் இறக்குகிறோம்.",
    ...
    ml: {
      ...
      hero_point_2: "തമിഴ്‌നാട്ടിലും കേരളത്തിലും എവിടെനിന്നും ചരക്കുകൾ കയറ്റുകയും ഇറക്കുകയും ചെയ്യുന്നു.",
