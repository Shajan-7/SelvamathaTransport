...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const translations = {
    en: {
      ...
      hero_desc: "Send anything, anywhere, anytime, on correct time. Operating 15+ heavy commercial trucks, 35+ experienced crew, and 24/7 booking support for 25+ years.",
    ...
    ta: {
      ...
      hero_desc: "எதையும், எங்கும், எப்போதும், சரியான நேரத்தில் கொண்டு சேர்ப்போம். 15+ கனரக லாரிகள், 35+ அனுபவமிக்க ஓட்டுநர்கள், 24/7 முன்பதிவு வசதி.",
    ...
    ml: {
      ...
      hero_desc: "ഏതൊരു ചരക്കും കൃത്യസമയത്ത് സുരക്ഷിതമായി എത്തിക്കുന്നു. 15+ ഹെവി ലോറികൾ, 35+ പരിചയസമ്പന്നരായ ഡ്രൈവർമാർ, 24/7 ബുക്കിംഗ്.",
